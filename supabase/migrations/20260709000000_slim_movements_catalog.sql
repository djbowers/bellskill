...
INSERT INTO public.movements ("Movement", "Primary Equipment", "# Primary Items", "Single or Double Arm", "Target Muscle Group", "Difficulty Level", "Movement Pattern #1") VALUES
  ...
  ('Two-Arm Kettlebell Clean', 'Kettlebell', 2, 'Double Arm', 'Shoulders', 'Intermediate', 'Hip Hinge'),
  ...
  ('Two-Arm Kettlebell Military Press', 'Kettlebell', 2, 'Double Arm', 'Shoulders', 'Intermediate', 'Vertical Push'),
  ...
  ('Two-Arm Kettlebell Jerk', 'Kettlebell', 2, 'Double Arm', 'Shoulders', 'Intermediate', 'Vertical Push'),
  ...
  ('Two-Arm Kettlebell Floor Press', 'Kettlebell', 2, 'Double Arm', 'Chest', 'Beginner', 'Horizontal Push'),
  ...
  ('Two-Arm Kettlebell Row', 'Kettlebell', 2, 'Double Arm', 'Back', 'Intermediate', 'Horizontal Pull'),
