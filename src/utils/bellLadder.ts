...
/**
 * The heaviest bell something has been logged at, and when it was first
 * reached. Lives here so both the pure derivation and the Deno-resolvable
 * progress module can name it without importing each other.
 */
